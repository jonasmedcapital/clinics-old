class Users::Accounts::Addresses::Create
  ...
  def address
    @address ||= ::Users::Accounts::AddressRepository.build(@account_params[:account_id])
  end
  ...
  def can_current_user_create_address?
    @can_current_user_create_address ||= ::UserPolicies.new(current_user.id, "create", "addresses").can_current_user?
  end
